...
namespace Shard
{
    class Bootstrap
    {
        ...
        private static void Setup(string path)
        {
            ...
            physics.Initialize(new OpenTK.Mathematics.Box3(-30.0f, -10.0f, -2.0f, 10.0f, 30.0f, 6.0f), new OpenTK.Mathematics.Vector3(1.0f)); // Replace this after scene implementation
